local M = {
	...
	keys = {
		...
		{ '<leader><tab>l', function() vim.cmd.tabnext() end, desc = 'Next tab' },
		{ '<leader><tab>h', function() vim.cmd.tabprevious() end, desc = 'Previous tab' },
		{ '<leader><tab>n', function() vim.cmd.tabnew() end, desc = 'New tab' },
		{ '<leader><tab>c', function() vim.cmd.tabclose() end, desc = 'Delete tab' },

		{ '<C-w>d', function() require('bufdelete').bufdelete(0, true) end, desc = 'Close buffer' },
